...
**Anti-arbitrage entre Pass (v1.5, décision fondateur — `DECISIONS.md` n°9)** : le Pass est **déduit des dates saisies, jamais choisi librement** — une demande couvrant ≥ 2 nuits bascule automatiquement en Pass Séjour, une « promenade » sur 10 jours est impossible à saisir. Compléments : signal `fraud_signals` sur tarif de candidature incohérent avec le type de service ; l'avis post-garde décrit le service réel. Pass Court maintenu à 14,90 € (garde 1 nuit incluse).

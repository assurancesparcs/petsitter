...
| **5** | **La marque et le domaine `.fr`** : quand arbitrez-vous ? (Je code tout sur la constante `[MARQUE]`, mais domaine = e-mails transactionnels, SEO, dépôt INPI.) → vérif dispo : https://www.afnic.fr/noms-de-domaine/tout-savoir/trouver-un-nom-de-domaine/ · dépôt : https://www.inpi.fr | **L'horloge d'indexation SEO d'un domaine neuf (3-6 mois) ne démarre qu'au domaine posé** ; changer après indexation coûte des mois. Devenu bloquant dès P1 (cf. phasage v1.1). | P1, e-mails, identité, SEO |
...
| **14** | **Distribution attendue du délai entre dépôt de demande et début de garde** : accepte-t-on des demandes déposées à plus de ~6 jours de l'échéance de réponse (vacances réservées des mois à l'avance — le cœur saisonnier) ? | CTO | **L'architecture de paiement de P3** : une pré-autorisation carte expire en 7 jours maximum (plafond réseau, non extensible pour notre secteur) → les réservations anticipées imposent un second mode « SetupIntent + débit off-session à l'acceptation » (cf. §3.1) |
